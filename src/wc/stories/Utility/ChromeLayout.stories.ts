...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Spacing-only structural chrome utility. `ds-chrome-space--sm|md|lg` sets matching padding and gap recipes (4, 8, or 16px); `ds-chrome-row|column` selects the axis. The utility never owns width or height.',
      },
    },
  },
};
