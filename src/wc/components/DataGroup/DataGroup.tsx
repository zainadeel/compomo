...
export class DataGroup {
  ...
  private readonly componentId = `ds-data-group-${++tableGroupSeq}`;
  ...
  private readonly position = new AnchoredPositionController({
    ...
    getPopup: () => this.el.querySelector<HTMLElement>('.data-group-popup'),
  ...
  render() {
    ...
    return (
      <Host
        class={{ 'data-group-vertical': this.vertical }}
      ...
      >
        ...
        {this.shouldRender || this.embedded ? (
          <div
            ...
            aria-label={name}
          >
            <div class="data-group__body">
              <div class="data-group__data-pane">
                <ChoiceListSection
                  heading="Data"
                  ariaLabel="Group data"
                  className="data-group__list"
                >
                  {this.vertical &&
                ...
                <div
                  ...
                  class="data-group__footer ds-choice-footer"
              ...
              <div class="data-group__order-pane">
                {this.grouping ? (
                  <ChoiceListSection
                    heading="Order"
                  ...
                  <div class="data-group__empty ds-choice-empty ds-empty-region">
