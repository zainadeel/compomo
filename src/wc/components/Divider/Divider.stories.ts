...
const BACKGROUND_CONTEXTS = [
  ...
  },
  {
    ...
    color: 'var(--color-navigation-foreground-primary)',
  },
  {
    id: 'always-dark',
    value: 'always-dark',
...
const meta: Meta = {
  ...
  argTypes: {
    ...
    inset: {
      ...
      options: INSETS,
      description:
        'Visual inset from the divider start/end edges. Uses TokoMo spacing token names.',
    },
    length: {
      control: 'text',
...
export const Playground: Story = {
  render: args => html`
    <div
      style="display: flex; ${args['orientation'] === 'vertical'
...
export const Horizontal: Story = {
  render: () => html`
    <div
      style="display: flex; flex-direction: column; gap: var(--dimension-space-200); width: 300px"
    >
...
export const Insets: Story = {
  render: () => html`
    <div
      style="display: flex; flex-direction: column; gap: var(--dimension-space-200); width: 360px"
    >
      ${INSETS.map(
        inset =>
          html` <div
            style="display: flex; flex-direction: column; gap: var(--dimension-space-075);"
          >
            <span
...
export const Backgrounds: Story = {
  render: () => html`
    <div
      style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: var(--dimension-space-150);"
    >
      ${BACKGROUND_CONTEXTS.map(
        context => html`
          <div
            style="display: flex; flex-direction: column; gap: var(--dimension-space-100); padding: var(--dimension-space-150); border-radius: var(--dimension-radius-100); background: ${context.background}; color: ${context.color};"
          >
...
export const SemanticSeparator: Story = {
  render: () => html`
    <div
      style="display: flex; flex-direction: column; gap: var(--dimension-space-200); width: 320px"
    >
      <p style="margin: 0">Visual-only divider is default and hidden from assistive tech.</p>
      <ds-divider></ds-divider>
      <p style="margin: 0">
        Use semantic only when the separator itself conveys document structure.
      </p>
