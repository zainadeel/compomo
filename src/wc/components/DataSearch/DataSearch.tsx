...
export class DataSearch {
  ...
  private readonly componentId = `ds-data-search-${++tableSearchSequence}`;
  ...
  render() {
    ...
    return (
      <Host
        class={{
          'data-search-host': true,
          'data-search-host--borderless': !this.hasBorder,
          'ds-control--md': true,
      ...
      >
        <div
          ...
          class="data-search__control ds-control-frame ds-control--md ds-interaction-fill"
        >
          <span
            class="data-search__icon ds-control-icon-box ds-interaction-fill__content"
            aria-hidden="true"
          >
            <ds-icon name="MagnifyingGlass" size="md" color="inherit" />
          </span>
          <div class="data-search__editor ds-interaction-fill__content">
            {selected.map(field => (
              <ds-chip
                class="data-search__chip"
                key={field.id}
                label={field.label}
                size="md"
                state="default"
            ...
            <input
              ...
              id={this.inputId}
              class="data-search__input ds-text--body-medium ds-text--regular"
              type="search"
              role="combobox"
              value={inputValue}
          ...
          {inputValue.length > 0 && !this.isInactive && (
            <ds-button-unfilled
              class="data-search__clear ds-interaction-fill__content"
              variant="icon"
              size="sm"
              icon="CrossCircle"
              hasBorder={false}
        ...
        {this.menuOpen && (
          <div
            ...
            class="data-search__popup ds-choice-popup"
            style={popupStyle}
          >
            <div
              id={this.listboxId}
              class="data-search__list ds-choice-list"
              role="listbox"
            ...
            >
              ...
              {visible.length === 0 && (
                <div class="data-search__empty ds-choice-empty ds-empty-region">
