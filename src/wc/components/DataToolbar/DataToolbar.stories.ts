...
const renderToolbar = (options?: {
  ...
  <ds-data-toolbar slot="header" label="Fleet table controls">
    <ds-data-saved-views
      slot="start"
      .views=${[
...
const meta: Meta = {
  title: 'Data controls/Toolbar',
  component: 'ds-data-toolbar',
  parameters: {
    docs: {
      description: {
        component:
...
export const NarrowOverflow: Story = {
  ...
  render: () => html`
    <div style="inline-size:20rem;">
      <ds-data-toolbar label="Fleet table controls">
        <ds-data-saved-views slot="start"></ds-data-saved-views>
        <ds-input
          slot="search"
          type="search"
          size="md"
          ...
          aria-label="Search fleet"
        ></ds-input>
        <ds-data-filter slot="trailing" aria-label="Filter fleet"></ds-data-filter>
        <ds-select
          slot="trailing"
          collapse-label
          size="md"
...
export const Borderless: Story = {
  render: () =>
    html`<ds-data-toolbar borderless>
      <ds-data-saved-views slot="start" .hasBorder=${false}></ds-data-saved-views>
      <ds-data-search slot="search" .hasBorder=${false}></ds-data-search>
      <ds-data-preferences slot="trailing" .hasBorder=${false}></ds-data-preferences>
    </ds-data-toolbar>`,
};
