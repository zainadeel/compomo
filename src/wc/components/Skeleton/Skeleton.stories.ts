...
const BACKGROUND_CONTEXTS = [
  ...
  },
  {
    ...
    value: 'medium',
    label: 'medium',
    background: 'var(--color-background-medium-brand)',
  },
  { id: 'bold', value: 'bold', label: 'bold', background: 'var(--color-background-bold-brand)' },
  {
    ...
    value: 'strong',
    label: 'strong',
    background: 'var(--color-background-strong-brand)',
  },
  {
    id: 'translucent',
    value: 'translucent',
...
const CANVAS_OUTLINE =
  'outline:var(--dimension-stroke-width-015) dashed var(--color-border-bold-brand);outline-offset:0;';
...
export const CanvasAnatomy: Story = {
  ...
  render: () => html`
    <div style="${REVIEW_STACK}">
      <div
        style="display:grid;grid-template-columns:120px 240px 1fr;align-items:center;gap:var(--dimension-space-200);"
      >
      ...
      >
        ...
        ></ds-skeleton>
        <ds-text as="span" variant="text-body-small" color="secondary"
          >20×20px canvas → 16×16px shape</ds-text
        >
      </div>
      <div
        style="display:grid;grid-template-columns:120px 240px 1fr;align-items:center;gap:var(--dimension-space-200);"
      >
        ...
        ></ds-skeleton>
        <ds-text as="span" variant="text-body-small" color="secondary"
          >32px canvas → 32px shape</ds-text
        >
      </div>
    </div>
  `,
...
export const TextScale: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Each skeleton is shown beside the corresponding ds-text metric box. Width remains composition-owned.',
      },
    },
  },
  render: () => html`
    <div
      style="display:grid;grid-template-columns:160px 240px 240px;align-items:center;gap:var(--dimension-space-100) var(--dimension-space-200);"
    >
...
export const ComposedTextLines: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'One skeleton represents one line box. Compose multiple atoms and vary their widths for multiline loading content.',
      },
    },
  },
  render: () => html`
...
export const IconScale: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Skeleton and ds-icon share the exact same square canvas at every iconography size. Icon shapes support square and circular treatments.',
      },
    },
  },
  render: () => html`
    <div
      style="display:grid;grid-template-columns:64px 80px 80px 80px;align-items:center;gap:var(--dimension-space-100) var(--dimension-space-150);"
    >
...
export const ControlScale: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Controls use the complete 16/24/32px density canvas. Default skeletons use 2px radius; rounded skeletons use the shared pill radius.',
      },
    },
  },
  render: () => html`
    <div
      style="display:grid;grid-template-columns:48px 120px 160px 120px 96px;align-items:center;gap:var(--dimension-space-150);"
    >
      <ds-text as="span" variant="text-caption" color="secondary">Size</ds-text>
...
export const BackgroundContexts: Story = {
  ...
  render: () => html`
    <div
      style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:var(--dimension-space-150);"
    >
      ${BACKGROUND_CONTEXTS.map(
        context => html`
...
export const Composition: Story = {
  parameters: {
    docs: {
      description: {
        story:
          'A representative composition built exclusively from icon, text, and control skeleton atoms.',
      },
    },
  },
  render: () => html`
    <div
      style="display:flex;align-items:flex-start;gap:var(--dimension-space-150);width:360px;padding:var(--dimension-space-200);border:var(--dimension-stroke-width-015) solid var(--color-border-secondary);border-radius:var(--dimension-radius-150);"
    >
