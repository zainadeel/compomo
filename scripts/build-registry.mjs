...
const COMPONENTS = [
  ...
  ['ButtonUnfilledIcon', {
    ...
    description: 'Square unfilled icon button for chrome actions, overflow triggers, and tool rail actions. Supports active, active-without-fill, bordered, dot, isInactive, and surface-aware interaction states.',
