...
const COMPONENTS = [
  ...
  ['CardSetting', {
    ...
    usesTokens: true,
    usesIcons: true,
    internalDeps: ['Text', 'ButtonUnfilledIcon', 'ButtonFilled'],
  }],
  ...
  ['ButtonFilled', {
    ...
    description: 'Square filled primary icon button. Intent-based colours with contrast fill pairing (bold→faint fg, strong→medium, medium→strong, faint→bold).',
    exports: ['ButtonFilled'],
    types: ['ButtonFilledIntent', 'ButtonFilledContrast'],
    props: {
      icon: { type: 'string', required: true, description: 'Canonical IcoMo icon export name.' },
      ...
      inactive: { type: 'boolean', default: 'false', description: 'Disables interaction.' },
      ariaLabel: { type: 'string', default: "'action'", description: 'Accessible name.' },
    },
    events: ['dsClick'],
    usesTokens: true,
    usesIcons: true,
  ...
  ['ButtonUnfilledIcon', {
    title: 'ButtonUnfilledIcon',
    tag: 'ds-button-unfilled-icon',
    description: 'Square unfilled icon button for chrome actions, overflow triggers, and tool rail actions. Supports active, active-without-fill, bordered, dot, inactive, and surface-aware interaction states.',
    exports: ['ButtonUnfilledIcon'],
    types: ['ButtonUnfilledIconBackground'],
    props: {
      icon: { type: 'string', required: true, description: 'Canonical IcoMo icon export name.' },
      isActive: { type: 'boolean', default: 'false', description: 'Active/selected state. Active always promotes icon color.' },
      activeFill: { type: 'boolean', default: 'true', description: 'Set false for shell chrome that needs active icon color without active fill.' },
      hasBorder: { type: 'boolean', default: 'false', description: 'Adds a tertiary 1px border.' },
      dot: { type: 'boolean', default: 'false', description: 'Shows a notification dot.' },
      inactive: { type: 'boolean', default: 'false', description: 'Disables interaction.' },
