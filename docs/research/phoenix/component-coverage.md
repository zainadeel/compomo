...
| Data visualization               | CardChart, ChartBar, ChartDonut, ChartLegend, ChartLine, TooltipChart                                                                                                                                                                                     | A shared visualization language and chart composition layer not present as public Phoenix families.                                                    |
