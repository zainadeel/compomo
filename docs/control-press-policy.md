...
| `Textarea` — native multiline editor and resize handle                                  | Focus/error/filled state and native resize feedback                                         | Native resize geometry                                                | Editable fields and their resize handle stay geometrically stable; multiline editing does not use momentary action-button scale.                                            |
